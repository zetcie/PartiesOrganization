...
<asp:Content ID="Content1" ContentPlaceHolderID="c1" runat="server">
    <div class="centered" style="position: absolute; top: 27vw; left: 50%; transform: translate(-50%, -50%);">
                    ...
                    <div class="card-body">
                        <form id="f1" runat="server" method="post" novalidate="novalidate">
                            ...
                            <div class="form-group">
                                ...
                                <asp:RangeValidator ID="RangeValidator1" runat="server" Style="color:orange" ErrorMessage="Ta sala nie zmieści tylu gości." ControlToValidate="places" MinimumValue="0" MaximumValue="500" Display="Dynamic"></asp:RangeValidator> 
                            </div>
                            <div class="form-group">
